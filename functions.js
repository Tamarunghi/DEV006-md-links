    ...
    return axios
      ...
      .catch((error) => {
        const validateFalse = {
          ...
          Text: link.text,
          File: link.file,
          Status: error.message.slice(0, 25),
          StatusText: "Fail",
        };
...
// /* absolute Path D */      validatePathDirectory('./linkTests')
//                            .then((isDirectory) => {
//                            console.log("--ValidatePathDirectory", isDirectory);
//                            })
//                            .catch((error) => {
//                            console.error("An error has occurred", error);
//                            });
//  /* To Absolute Path */    const resultToAbsolutePath = toAbsolutePath("./linkTests");
//                            console.log("--toAbsolutePath: " + resultToAbsolutePath);                   
//     /* Recursive */        const filesMd = recursive("./linkTests");
//                            console.log("--Recursive", filesMd);

//     /* Validate Path F*/   const resultvalidateFile = validateFile("./linkTests");
//                            console.log("--validateFile: " + resultvalidateFile);
//      /* Read Md file */    readMdFile("./linkTests/cleaner.md")
//                            .then(result =>{
...
//                            console.error(error)
//                            });                                                    
//     /* Extract Links */    readMdFile("./linkTests/cleaner.md")
//                            .then(result =>{
